...
(function() {
  describe("ItemService", function() {
    var $httpBackend, AuthService, ItemService, blobToFile, createArg, createPayload, createResponse, dataURLtoBlob, dataUrlExample, destroyArg, fileExample, indexResponse, json2FormData, updateArg, updatePayload, updateResponse;
    ...
    it("can look into formdata payload (with chrome developer tool)", function() {
      var xhr;
      xhr = new XMLHttpRequest;
      xhr.open("POST", "/", true);
      return xhr.send(json2FormData({
        category_id: 1,
    ...
    beforeEach(inject(function(_ItemService_, _$httpBackend_) {
      var ref;
      return ref = [_ItemService_, _$httpBackend_], ItemService = ref[0], $httpBackend = ref[1], ref;
    }));
    afterEach(function() {
    ...
    describe(".create", function() {
      return it("", function() {
        $httpBackend.expectPOST("/api/items", void 0, function(headers) {
    ...
    describe(".update", function() {
      return it("", function() {
        $httpBackend.expectPUT("/api/items/1", void 0, function(headers) {
          return headers["Authorization"] === "sP3hoKN5-y-tRtagTf2B";
