...
(function() {
  describe("ItemService", function() {
    var $httpBackend, AuthService, ItemService, createArg, createPayload, createResponse, dataURLtoBlob, dataUrlExample, destroyArg, indexResponse, updateArg, updatePayload, updateResponse;
