...
(function() {
  describe("CategoryService", function() {
    var $httpBackend, $resource, AuthService, CategoryService, createArg, createPayload, createResponse, destroyArg, response1, updateArg, updatePayload, updateResponse;
    createArg = {
      name: "Electric Witch",
