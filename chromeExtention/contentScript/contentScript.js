...
(function() {
  var $ext_div0, $ext_div1, $ext_div2, $ext_root, $ext_ul, $ext_ul2, $input0, $input1, $input2, DELAY, clicks, lookUpEijiro, lookUpWord, resetView, setPopover, shootAndUpload, timer;
