...
(function() {
  var $ext_div0, $ext_div1, $ext_div2, $ext_ul, $ext_ul2, $input0, $input1, DELAY, clicks, lookUpEijiro, lookUpWord, shootAndUpload, timer;
  ...
  $("body").append($ext_div0.append($input0).append($input1)).append($ext_div1.append($ext_ul)).append($ext_div2.append($ext_ul2));
  ...
  lookUpEijiro = function() {
    ...
    return chrome.runtime.sendMessage({
      ...
      return $(html).find('#resultsList > ul > li').each(function() {
        var $mean, $meanings, $popover_content, $popover_root, eng_voc;
