...
(function() {
  describe("CategoryService", function() {
    var $httpBackend, $resource, AuthService, CategoryService, createArg, createPayload, createResponse, destroyArg, response1, showArg, showResponse, updateArg, updatePayload, updateResponse;
    createArg = {
      name: "Electric Witch",
    ...
    describe(".create", function() {
      return it("", function() {
        $httpBackend.expectPOST("/api/categories", createPayload, function(headers) {
    ...
    describe(".update", function() {
      return it("", function() {
        $httpBackend.expectPUT("/api/categories/1", updatePayload, function(headers) {
          return headers["Authorization"] === "sP3hoKN5-y-tRtagTf2B";
